...
namespace 美术馆.管理员
{
    public partial class changeQuestionp : Form
    {
        public SqlConnection conn = null;
        public Personnel_main page;
        private int userid;
        public changeQuestionp(Personnel_main l, int userid)
        {
            InitializeComponent();
            this.conn = l.conn;
            this.userid = userid;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sdr.Close();
                    changeQuestionSecondp change = new changeQuestionSecondp(this, this.userid);
                    this.Hide();
                    change.Show();
                }
                else
